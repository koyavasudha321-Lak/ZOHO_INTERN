...
public class Ziggy{
    ...
    //Adding Customers
    public static void addCustomer(String cId, String cName, String cEmail, long cPh, String cAddress, int X, int Y, String password) {
        ...
        try {
            ...
            // String sql = ;
//            PreparedStatement xs = conn.prepareStatement("CREATE EXTENSION pgcrypto;");
            PreparedStatement st = conn.prepareStatement("INSERT INTO CUSTOMERS VALUES(?, ?, ?, ?, ?, ?, ?, PGP_SYM_ENCRYPT(?, 'AES_KEY'));");
...
//    }
    ...
    public static void displayCustomers() {
        ...
        try {
            ...
            //PreparedStatement xs = conn.prepareStatement("CREATE EXTENSION pgcrypto;");
            PreparedStatement ps = conn.prepareStatement("SELECT cid, cname, cemail, cph, caddress, x_co_ordinate, y_co_ordinate, password FROM CUSTOMERS;");
            ...
            rs = ps.executeQuery();
            System.out.println("The Restaurants and Drivers within given Range are: ");
            System.out.println("cID\t\tcName\t\tcEmail\t\t\t\tcPhone\t\t\tcAddress\tX_Co_ordinate\tY_Co_Ordinate\tPassword");
            System.out.println("===============================================================================================================================");
            while ( rs.next() ) {
                System.out.println(rs.getString("cId") + "\t" + rs.getString("cName")+ "\t\t" + rs.getString("cEmail")+"\t\t" + rs.getLong("cPh") + "\t\t"+ rs.getString("cAddress") +"\t\t\t" +rs.getInt("x_co_ordinate") +"\t\t\t\t"+rs.getInt("y_co_ordinate")+"\t\t\t\t"+ rs.getString("password"));
                System.out.println("---------------------------------------------------------------------------------------------------------------------------");
            }
            System.out.println("Sucessfully Displayed!!!...");
    ...
    public static void displayOrders() {
        ...
        try {
            ...
            System.out.println("oID\t\trId\t\tcId\t\tTimeOfOrder\t\tdId\t\tCompletedOrderTimeSTamp");
            System.out.println("====================================================================================================");
            while ( rs.next() ) {
                System.out.println(rs.getString("oId") + "\t\t" + rs.getString("rId")+ "\t\t" + rs.getString("cId")+"\t" + rs.getLong("TimeOrder") + "\t\t"+ rs.getString("dId")+"\t\t"+rs.getString("completeordertime"));
                System.out.println("-------------------------------------------------------------------------------------------------");
            }
            System.out.println("Sucessfully Displayed!!!...");
    ...
    public static void displayDrivers() {
        ...
        try {
            ...
            System.out.println("====================================================================================================");
            while ( rs.next() ) {
                System.out.println(rs.getString("dId") + "\t\t" + rs.getString("dName")+ "\t\t\t" + rs.getBoolean("Available")+ "\t\t\t\t" +rs.getInt("x_co_ordinate") +"\t\t\t\t\t"+rs.getInt("y_co_ordinate"));
                System.out.println("-------------------------------------------------------------------------------------------------");
            }
            System.out.println("Sucessfully Displayed!!!...");
    ...
    //Authenicate Customer
    public static void authCustomer(String cId, String password){
        Connection conn = null;
        ...
        try {
            ...
            //PreparedStatement ps;// st = conn.prepareStatement("CREATE EXTENSION pgcrypto;");

            PreparedStatement ps = conn.prepareStatement("SELECT PGP_SYM_DECRYPT(password::bytea, 'AES_KEY') as password FROM Customers WHERE cId = ?;");
            ResultSet rs;
            ps.setString(1, cId);
            ...
            while(rs.next()){
                ...
                if(key.equals(password)) {
                    System.out.println("Authenticated Your Details Successfully.....");
                }
                else {
    ...
    //place order
    public static void placeOrder(String cId, String rId, String dId, Long timeOrder){
        Connection conn = null;
        try {
            //Class.forName("org.postgresql.Driver"); no need to register driver as we r using latest version of jdbc driver
            System.out.println("Connecting to database!!!...");
            ...
            PreparedStatement st = conn.prepareStatement("INSERT INTO ORDERS(rId, cId, TimeOrder, did) VALUES(?, ?, ?,?);");
    ...
    //Display best_Optimal driver
    public static String displayBest_Optimal_Driver(int K, String cId, String rId) {
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("SELECT c.cid, r.rid, d.did, d.dname,sqrt(((c.x_co_ordinate - r.x_co_ordinate) * (c.x_co_ordinate - r.x_co_ordinate)) + ((c.y_co_ordinate - r.y_co_ordinate) * (c.y_co_ordinate - r.y_co_ordinate))) as dist_C_R,sqrt(( (c.x_co_ordinate -d.x_co_ordinate) * (c.x_co_ordinate - d.x_co_ordinate)) + ((c.y_co_ordinate - d.y_co_ordinate) * (c.y_co_ordinate - d.y_co_ordinate))) as dist_C_D from drivers d, customers c, restaurant r WHERE (sqrt(( (c.x_co_ordinate - r.x_co_ordinate) * (c.x_co_ordinate - r.x_co_ordinate)) + ((c.y_co_ordinate - r.y_co_ordinate) * (c.y_co_ordinate - r.y_co_ordinate))) <= ?) and (sqrt(( (c.x_co_ordinate - d.x_co_ordinate) * (c.x_co_ordinate - d.x_co_ordinate)) + ((c.y_co_ordinate - d.y_co_ordinate) * (c.y_co_ordinate - d.y_co_ordinate))) <= ?) AND c.cid = ? AND r.rId = ? AND available = true order by dist_C_D, dist_C_R LIMIT 1;");
            ResultSet rs;
    ...
    public static void UpdateCompleteOrderStatus(int oId, long timeOrder) {
        ...
        try {
            ...
            PreparedStatement ps = conn.prepareStatement("UPDATE ORDERS SET completeOrderTime = ? WHERE oId = ?;");
            ResultSet rs;

            ps.setLong(1, timeOrder);
            ps.setInt(2,oId);
            ...
            System.out.println("The Completed Order Timestamp updated!!!!.... ");
    ...
    public static void make_driver_Av_OR_Unavailable(String dId, Boolean flag) {
        Connection conn = null;
        ...
        try {
            ...
            PreparedStatement st = conn.prepareStatement("UPDATE drivers SET available = ? where dId = ?");
            ...
            System.out.println("Driver is on Work");
    ...
    public static void main(String args[]) {
        ...
        int X, Y, dPrice;
        long cPh;
        String rId, cId, dId, dName, rName, cName, cAddress, cEmail, password;
        boolean dAvailable;
        Timestamp timestamp;
        long timeOrder;
        int oId;
        while(true){
            ...
            switch(ch) {
                ...
                case 1:  System.out.print("Enter customer Id to insert!!!! : ");
                    ...
                    System.out.print("Enter password to insert!!!! : ");
                    password = sc.next();

                    System.out.println("Adding Customers into Customer table");

                    m.addCustomer(cId, cName, cEmail, cPh,cAddress,X, Y, password);
                    break;
                case 2:
                ...
                case 3: System.out.print("Enter DRIVERS Id to insert!!!! : ");
                    ...
                    System.out.print("Enter enter true if driver is available to insert!!!! : ");
...
//                    break;
                ...
                case 7: System.out.println("Displaying Customer Details....");
                    m.displayCustomers();
                    break;
                case 8: System.out.println("Displaying Restaurant Details....");
                    m.displayRestaurants();
                    break;
                case 9: System.out.println("Displaying Order Details....");
                    m.displayOrders();
                    break;
                case 10: System.out.println("Displaying Driver Details....");
                    m.displayDrivers();
                    break;
                case 11: System.out.println("Authentication process STARTED....");
                    System.out.println("Enter CustomerID....");
                    cId = sc.next();
                    System.out.println("Enter password.......");
                    password = sc.next();
                    m.authCustomer(cId, password);
                    break;
                case 4:System.out.println("Placing order....");
                    ...
                    K = sc.nextInt();
                    dId = m.displayBest_Optimal_Driver(K, cId, rId);
                    timestamp = new Timestamp(System.currentTimeMillis());
                    timeOrder = timestamp.getTime();
                    timeOrder /= 1000;
                    m.placeOrder(cId,rId, dId, timeOrder);
                    m.make_driver_Av_OR_Unavailable(dId,false);
                    break;
                case 12:System.out.println("Enter orderId to update complete Order timestamp status!!....");
                    oId = sc.nextInt();
                    System.out.println("current timestamp is processing to insert!!!! : ");
                    timestamp = new Timestamp(System.currentTimeMillis());
                    timeOrder = timestamp.getTime();
                    timeOrder /= 1000;
                    m.UpdateCompleteOrderStatus(oId, timeOrder);
                    System.out.println("Enter Driver Id to update driver's status!!!........");
                    dId = sc.next();
                    m.make_driver_Av_OR_Unavailable(dId,true);
                    break;


                case 13:System.out.println("Ending The Program!!!!.....");
                    return;
